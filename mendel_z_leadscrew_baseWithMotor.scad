...
//translate([-4.5,-36.4,0]) import_stl("include/z-leadscrew-base_2off.stl");
...
module z_leadscrew_cutouts () {
	...
	// 608 bearing
	translate([z_bearing_inset,0,0]) cylinder(h=leadscrew_base_height*4,r=bearing_608_rad,center=true, $fn=20);
	// Long M8 bolt holes
